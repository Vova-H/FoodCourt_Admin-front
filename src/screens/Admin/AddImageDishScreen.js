...
const AddImageDishScreen = (props) => {
    ...
    const locAddDishImageFailed = i18n.t("addDishImageScreen.addDishImageFailed");
    ...
    const uploadImageHandler = async (uri, currentRetryCount = 0) => {
        try {
            ...
            if (currentRetryCount < 5) {
                ...
                console.log('Add dish Failed after retries');
                Alert.alert(locMessage, locAddDishImageFailed);
            }
        }
    };
